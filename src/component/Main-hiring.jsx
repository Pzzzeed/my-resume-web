            ...
            <div className='hiring-box'>
                <div className='hiring-item'>
                    <div className='hiring-item-img'>
                        <img src="./src/image/conversation.png" alt="communicative" className='hiring-img'/>
                    </div>
                    <h3>Communicative</h3>
                ...
                <div className='hiring-item'>
                    <div className='hiring-item-img'>
                        <img src="./src/image/techsupport.png" alt="techsupport" className='hiring-img'/>
                    </div>
                    <h3>Professional</h3>
                ...
                <div className='hiring-item'>
                <div className='hiring-item-img'>
                    <img src="./src/image/collaborative.png" alt="collaborative" className='hiring-img'/>
                    </div>
                    <h3>Collaborative</h3>
                ...
                <div className='hiring-item'>
                <div className='hiring-item-img'>
                    <img src="./src/image/star.png" alt="star" className='hiring-img'/>
                    </div>
